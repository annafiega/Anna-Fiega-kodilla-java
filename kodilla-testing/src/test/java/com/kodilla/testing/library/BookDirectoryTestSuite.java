...
public class BookDirectoryTestSuite {
    ...
    public void testListBooksInHandsOf() {
        ...
        LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
        LibraryUser user1= new LibraryUser("Jan","Kowalski","86");
        LibraryUser user2= new LibraryUser("Janusz","Kowalski","86");
        LibraryUser user3= new LibraryUser("Adam","Kowalski","86");

        List<Book> resultListOf0BooksInHandsOf = new ArrayList<Book>();
        ...
        when(libraryDatabaseMock.listBooksInHandsOf(user1))
                .thenReturn(resultListOf0BooksInHandsOf);
        when(libraryDatabaseMock.listBooksInHandsOf(user2))
                .thenReturn(resultListOf1BooksInHandsOf);
